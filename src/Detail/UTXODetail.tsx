...
export class UTXODetail extends React.Component<UTXODetailProps> {
    ...
    async create() {
        ...
        const data = {
            program: this.props.contract.txn_models.map((t) => t.get_json()),
        };
    ...
    render() {
        ...
        if (this.props.entity.txn instanceof PhantomTransactionModel) {
            ...
            const spends = this.props.entity.utxo.spends.map((elt, i) => (
                <ListGroup.Item
                    ...
                    variant="dark"
                >
                    <ListGroup horizontal={true} className="Spend">
        ...
        const spends = this.props.entity.utxo.spends.map((elt, i) => (
            <ListGroup.Item key={get_wtxid_backwards(elt.tx)} variant="dark">
                <ListGroup horizontal={true} className="Spend">
                    <ListGroup.Item variant="dark">
                        <Hex value={elt.get_txid()} />
                    </ListGroup.Item>
